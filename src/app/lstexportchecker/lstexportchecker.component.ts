...
@Component({
  selector: 'app-lstexportchecker',
  templateUrl: './lstexportchecker.component.html',
  styleUrls: ['./lstexportchecker.component.css']
})
export class LstexportcheckerComponent implements OnInit {
  ...
  nestedGrids : any =[];
  initRowDetails : any;
  HeaderJson = '[{"BookingAsk":"005","BookingNo":"B00005","ShipperName":"Mr. Jeab","AgentName":"Mr. Hong Kait","Status":"Checker","TransactionDate":"12/7/2018","Remark":"VIP"},{"BookingAsk":"006","BookingNo":"B00006","ShipperName":"Mr. John","AgentName":"Ms. Henery Kate","Status":"Checker","TransactionDate":"12/7/2018","Remark":"VIP"}]'
  DetailJson = '[{"BookingAsk":"005","DocNo":"DOC-20180712001","ShippingMark":"A123/5","SKUDetail":"Refined Salt","D_W":"20","D_W":"20","D_D":"20","D_L":"20","ReceivedQTY":"250","UOM":"Bag","TotalCBM":"8","Remark":"with low qty"},{"BookingAsk":"006","DocNo":"DOC-20180712002","ShippingMark":"AA/254","SKUDetail":"Chlorinator","D_W":"34","D_D":"44","D_L":"34","ReceivedQTY":"50","UOM":"PCs","TotalCBM":"434","Remark":"remark"}]';
