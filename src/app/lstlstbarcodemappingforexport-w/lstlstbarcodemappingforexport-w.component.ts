...
{ 
    ...
    this.router.navigate([ {outlets: { modal: 'setbarcodemappingforexport-w' } } ]);
...
CellDoubleclick(event:any)
{
    ...
    this.router.navigate([ {outlets: { modal: ['setbarcodemappingforexport-w',rowdata.Ask,rowdata.AgentAsk] } } ]);
