...
@Component({
  selector: 'app-lstdeliverforexport-w',
  templateUrl: './lstdeliverforexport-w.component.html',
  styleUrls: ['./lstdeliverforexport-w.component.css']
})
export class LstdeliverforexportWComponent implements OnInit {

  @ViewChild('HeaderGrid') HeaderGrid: jqxGridComponent;
  values: number[] = [102, 115, 130, 137];
  //Place holder
  ContainerPlaceHolder: string;
  SealNoPlaceHoler: string;
  ...
  nestedGrids : any =[];
  initRowDetails : any;
  HeaderJson = '[{"BookingAsk":"003","BookingNo":"B00003","ShipperName":"Mr. Jeffy","AgentName":"Joshier","Status":"Delivery","TransactionDate":"12/7/2018","Remark":"VIP"},{"BookingAsk":"004","BookingNo":"B00004","ShipperName":"Mr. Edwen Poh","AgentName":"Miss. Rebecca","Status":"Delivery","TransactionDate":"12/7/2018","Remark":"VIP"}]'
  ...
  bindPlaceholder()
  {
    this.ContainerPlaceHolder="Container No";
    this.SealNoPlaceHoler= "Seal No";
    this.PickListPlaceholder= "Pick List No";
    this.statusplaceholder= "Status";
    this.trdateplaceholder= "Transaction Date";
  } 
